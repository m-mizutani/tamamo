...
// mockAgentRepository implements interfaces.AgentRepository for testing
...
func (m *mockAgentRepository) GetAgent(ctx context.Context, id types.UUID) (*agent.Agent, error) {
	if agent, exists := m.agents[id.String()]; exists {
		return agent, nil
	}
	return nil, fmt.Errorf("agent not found")
...
func (m *mockAgentRepository) UpdateAgent(ctx context.Context, agent *agent.Agent) error {
	m.agents[agent.ID.String()] = agent
	return nil
}

func (m *mockAgentRepository) addAgent(agent *agent.Agent) {
	m.agents[agent.ID.String()] = agent
}

// Implement other required methods (minimal implementation for testing)
func (m *mockAgentRepository) CreateAgent(ctx context.Context, agent *agent.Agent) error { return nil }
func (m *mockAgentRepository) GetAgentByAgentID(ctx context.Context, agentID string) (*agent.Agent, error) {
	return nil, nil
}
func (m *mockAgentRepository) GetAgentByAgentIDActive(ctx context.Context, agentID string) (*agent.Agent, error) {
	return nil, nil
}
func (m *mockAgentRepository) ListAgents(ctx context.Context, offset, limit int) ([]*agent.Agent, int, error) {
	return nil, 0, nil
}
func (m *mockAgentRepository) ListAgentsByStatus(ctx context.Context, status agent.Status, offset, limit int) ([]*agent.Agent, int, error) {
	return nil, 0, nil
}
func (m *mockAgentRepository) CountAgents(ctx context.Context) (int, error) { return 0, nil }
func (m *mockAgentRepository) CountAgentsByStatus(ctx context.Context, status agent.Status) (int, error) {
	return 0, nil
}
func (m *mockAgentRepository) DeleteAgent(ctx context.Context, id types.UUID) error { return nil }
func (m *mockAgentRepository) UpdateAgentStatus(ctx context.Context, id types.UUID, status agent.Status) error {
	return nil
}
func (m *mockAgentRepository) AgentIDExists(ctx context.Context, agentID string) (bool, error) {
	return false, nil
}
func (m *mockAgentRepository) CreateAgentVersion(ctx context.Context, version *agent.AgentVersion) error {
	return nil
}
func (m *mockAgentRepository) GetAgentVersion(ctx context.Context, agentUUID types.UUID, version string) (*agent.AgentVersion, error) {
	return nil, nil
}
func (m *mockAgentRepository) GetLatestAgentVersion(ctx context.Context, agentUUID types.UUID) (*agent.AgentVersion, error) {
	return nil, nil
}
func (m *mockAgentRepository) UpdateAgentVersion(ctx context.Context, version *agent.AgentVersion) error {
	return nil
}
func (m *mockAgentRepository) ListAgentVersions(ctx context.Context, agentUUID types.UUID) ([]*agent.AgentVersion, error) {
	return nil, nil
}
func (m *mockAgentRepository) ListActiveAgents(ctx context.Context, offset, limit int) ([]*agent.Agent, int, error) {
	return nil, 0, nil
}
func (m *mockAgentRepository) ListActiveAgentsWithLatestVersions(ctx context.Context, offset, limit int) ([]*agent.Agent, []*agent.AgentVersion, int, error) {
	return nil, nil, 0, nil
}
func (m *mockAgentRepository) ListAgentsByStatusWithLatestVersions(ctx context.Context, status agent.Status, offset, limit int) ([]*agent.Agent, []*agent.AgentVersion, int, error) {
	return nil, nil, 0, nil
}
