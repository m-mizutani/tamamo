...
func TestServer_GraphQLEndpoint(t *testing.T) {
	...
	graphqlCtrl := graphql_controller.NewResolver(memRepo, agentUseCase, nil, nil) // nil user usecase and factory for tests
...
func TestServer_GraphQLQuery_Threads(t *testing.T) {
	...
	// Create GraphQL controller
	graphqlCtrl := graphql_controller.NewResolver(memRepo, nil, nil, nil)
